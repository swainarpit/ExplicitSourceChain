...
print(ggplot(data=dataC,aes(group=varn,
        ...
        geom_line(data=dataU,aes(x=time,y=var))+
        ...
        scale_y_continuous(name="Fraction labelled",sec.axis=sec_axis(~.*1,name='Body Deuterium Concentration'))+
...
# ggsave('FigD.pdf',width=8,height=5)
# ggsave('FigD.svg',width=8,height=5)
# ggsave('FigD.png',width=8,height=5)
