...
pdf_combine(mixedsort(list.files(pattern='.pdf')),output='FigureX1_Fits.pdf')
...
#ggsave('Figure3.pdf',width=8,height=5)
#ggsave('Figure3.svg',width=8,height=5)
#ggsave('Figure3.png',width=8,height=5)
