...
##Main block
tau <- 1; tstp <- 0.1; k <- 2; tmax <- 5 #Set timeline and type of differentiation
...
pdf_combine(mixedsort(list.files(pattern='.pdf')),output='Fig4_Fits.pdf') #Combine all the pdfs
...
# ggsave('Fig4.pdf',width=8,height=7)
# ggsave('Fig4.svg',width=8,height=7)
# ggsave('Fig4.png',width=8,height=7)
